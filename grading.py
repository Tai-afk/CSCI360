...
class Grades:
    ...
    def grade(self, gradingModule, exceptionMap={}, bonusPic=False,forSubmission = False, vocareumLeaderBoardScoreFile = None):
        """
...
""" % (prereq, q, q, prereq))
        ...
        if vocareumLeaderBoardScoreFile != None:
            with open(vocareumLeaderBoardScoreFile, "a") as f:
                for q in self.questions:
                    f.write("%s, %d\n"% (q, self.points[q]))
                f.write('Total, %d\n' % (self.points.totalCount()))
