...
def readCommand(argv):
    ...
    parser.add_option('--vocaLeaderboardScoreFile',
                    dest = 'vocareumLeaderBoardScoreFile',
                    default = None,
...
def evaluate(generateSolutions, testRoot, moduleDict, exceptionMap=ERROR_HINT_MAP,
             ...
             vocareumLeaderBoardScoreFile = None):
            ...
            def makefun(testCase, solution_file):
                if generateSolutions:
                    ...
                    if printTestCase:
                        ...
                        return lambda grades: testCase.execute(grades, moduleDict, solutionDict,vocareumLeaderBoardScoreFile = vocareumLeaderBoardScoreFile)
    ...
    grades.grade(sys.modules[__name__], bonusPic=projectParams.BONUS_PIC,forSubmission=forSubmission, vocareumLeaderBoardScoreFile = vocareumLeaderBoardScoreFile)
...
if __name__ == '__main__':
    ...
    if not (options.vocareumLeaderBoardScoreFile is None):
        with open(options.vocareumLeaderBoardScoreFile, "w") as f:
            f.write("")
    ...
    if options.runTest != None:
        ...
        evaluate(options.generateSolutions, options.testRoot, moduleDict,
                 ...
                 vocareumLeaderBoardScoreFile = options.vocareumLeaderBoardScoreFile)
